...
function Doctors_completed() {
    ...
    useEffect(() => {
        ...
        $.ajax({
            url: 'http://localhost:8000/api/v2/doctor/apps/completed',
            method: 'POST',
            headers: {
                    ...
                    <div className="bottom-container__table">
                        <div className="box transaction-box">
                            ...
                            <div className="header-container">
                                <h5 className="section-header">completed</h5>
...
export default Doctors_completed;
