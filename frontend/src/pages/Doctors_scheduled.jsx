...
function Doctors_scheduled() {
    ...
    useEffect(() => {
        ...
        $.ajax({
            url: 'http://localhost:8000/api/v2/doctor/apps/scheduled',
            method: 'POST',
            headers: {
                ...
                <div className="bottom-container">
                    <div className="bottom-container__table">
                        <div className="box transaction-box">
                            <h6 className='liner'>See below scheduled apps</h6>
                            <div className="header-container">
                                <h3 className="section-header">Scheduled</h3>
...
export default Doctors_scheduled;
