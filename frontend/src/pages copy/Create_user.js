...
function Createuser() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:8000/api/v2/user/create', {
        method: 'POST',
        headers: {
                    ...
                    <div className="bottom-container__left formbox">
                        <div className="box spending-box">
                            <div className="header-container">
                                <h3 className="section-header">Add a user</h3>
                            ...
                            <div className="">
                                <form className="container" onSubmit={handleSubmit}>
                                    <div className="form">
                                        ...
                                        <textarea className="input" name="address" value={formData.address} onChange={handleChange}></textarea>
                                        </div>

                                        <div className="field">
                                        <label htmlFor="email">Email</label>
                                        <input className="input" type="text" name="email" placeholder="name@website.com" value={formData.email} onChange={handleChange} />
                                        </div>

                                        <div className="field">
                                        <label htmlFor="phone">Phone number</label>
                                        <input className="input" type="text" name="phone_number" value={formData.phone} onChange={handleChange} />
                                        </div>
                                        ...
                                        <input className="input" type="number" name="id_number" value={formData.id_number} onChange={handleChange} />
                                        </div>
