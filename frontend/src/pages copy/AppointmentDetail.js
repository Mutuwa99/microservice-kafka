...
const AppDetail = () => {
    ...
    const handleViewReport = () => {
        console.log("sent" , app.pat_id)
        navigate('/medical-report', { state: {  appId } });
      }; 
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          const authToken = localStorage.getItem('authToken');
          const response = await fetch('http://localhost:8000/api/v2/doctors/update_app', {
            method: 'POST',
            headers: {
              'Authorization': `Token ${authToken}`,
              'Content-Type': 'application/json'
        ...
        <div className="container">
            ...
            <main className="main-content">
                <div className="top-container">
                    ...
                    <button style={{width:'98%', margin:'5px',marginBottom:'10px'}} className='btn reprt' onClick={handleViewReport} >view medical history</button>
                            ...
                            <div className="">
                                <form className="container" onSubmit={handleSubmit}>
                                    ...
                                    <div className="field">
                                        ...
                                        <input className="input" name="doctor" value={app.doctor} onChange={handleChange} required/> 
                                    </div>

                                    <div className="field">
                                        <label htmlFor="patient">Patient</label>
                                        <input className="input" name="patient" value={app.patient} onChange={handleChange} required />
                                    </div>
