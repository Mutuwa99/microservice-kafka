...
function Dashboard() {
    ...
    useEffect(() => {
        ...
        $.ajax({
            url: 'http://localhost:8000/api/v2/data',
            method: 'GET',
            headers: {
                ...
                <div className="bottom-container">
                    ...
                    <div className="bottom-container__right">
                        <div className="box">
                            ...
                            <h1 className="price">{data.emergencapp}<span className="price-currency">(Apps)</span></h1>
                        ...
                        <div className="box spending-box">
                            <div className="header-container">
                                <h3 className="section-header">Top Doctors</h3>
                                <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M5 10.4166C3.9 10.4166 3 11.3541 3 12.5C3 13.6458 3.9 14.5833 5 14.5833C6.1 14.5833 7 13.6458 7 12.5C7 11.3541 6.1 10.4166 5 10.4166Z" stroke="#1A202C" stroke-width="1.5"/>
                                    <path d="M19 10.4166C17.9 10.4166 17 11.3541 17 12.5C17 13.6458 17.9 14.5833 19 14.5833C20.1 14.5833 21 13.6458 21 12.5C21 11.3541 20.1 10.4166 19 10.4166Z" stroke="#1A202C" stroke-width="1.5"/>
                                    <path d="M12 10.4166C10.9 10.4166 10 11.3541 10 12.5C10 13.6458 10.9 14.5833 12 14.5833C13.1 14.5833 14 13.6458 14 12.5C14 11.3541 13.1 10.4166 12 10.4166Z" stroke="#1A202C" stroke-width="1.5"/>
                            ...
                            <div className="pie-chart">
                                {/* <image src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.istockphoto.com%2Fphotos%2Fconfetti-balloons&psig=AOvVaw1hBxYxBpUHcpWG3xNwTYIC&ust=1717861728474000&source=images&cd=vfe&opi=89978449; '10px,&ved=0CBIQjRxqFwoTCODauuLryYYDFQAAAAAdAAAAABAE"></image> */}
                                {/* <img src="https://media.istockphoto.com/id/493119586/photo/confetti-balloons-a10.jpg?s=612x612&w=0&k=20&c=BZYcskThGhb2G81pK2uSmiLPI36BJd9fiA0TS4me9cg=" alt="My Image" style={{ width: '120%',marginTop:'30px', maxWidth: '800px' }} /> */}
                            </div>
                            <div className="overall-spending">
                                <h4>our top Doctor</h4>
                                <span>DR Tshima</span>
                            </div>
                        </div>
                    </div>
