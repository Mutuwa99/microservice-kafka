...
import { faBars,faHome ,faTrash,faUserPlus,faSpinner,faCheckCircle,faEye, faSearch, faTh, faUser, faComments, faChartPie, faFolder, faShoppingCart, faHeart, faCog, faSignOutAlt } from '@fortawesome/free-solid-svg-icons';
...
function Apps() {
    ...
    useEffect(() => {
        ...
        $.ajax({
            url: 'http://localhost:8000/api/v2/app',
            method: 'GET',
            headers: {
                ...
                <div className="bottom-container">
                    <div className="bottom-container__table">
                        <div className="box transaction-box">
                            <h6 className='liner'>See below our Apps</h6>
                            <div className="header-container">
                                <h3 className="section-header">Apps List</h3>
                            ...
                            <table className="transaction-history">
                                ...
                                {data && data.map((Apps, index) => (
                                    <tr key={index}>
                                        ...
                                        <td>
                                        <FontAwesomeIcon icon={faEye} style={{ color: '',fontSize: '20px' }}  /> <span></span>
                                        <FontAwesomeIcon icon={faTrash} style={{ color: 'red',fontSize: '20px' }} /> <span></span>
                                        </td>
                                    </tr>
                                ))}
