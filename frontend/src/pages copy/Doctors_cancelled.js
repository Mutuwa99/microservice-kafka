...
function Doctors_cancelled() {
    ...
    useEffect(() => {
        ...
        $.ajax({
            url: 'http://localhost:8000/api/v2/doctor/apps/cancelled',
            method: 'POST',
            headers: {
                ...
                <div className="bottom-container">
                    <div className="bottom-container__table">
                        <div className="box transaction-box">
                            <h6 className='liner'>See below cancelled apps</h6>
                            <div className="header-container">
                                <h3 className="section-header">Cancelled</h3>
...
export default Doctors_cancelled;
